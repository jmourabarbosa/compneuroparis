...
test('buildInstitutePiCountMap counts legacy name-only records when they match a canonical institute', () => {
  ...
  assert.equal(getInstitutePiCount(institutes[0], countMap), 1);
});
